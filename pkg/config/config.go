...
type config struct {
	Env struct {
		...
		SyncTaskTime string `yaml:"syncTaskTime"`
	} `yaml:"env"`
	WPS struct {
...
func initEnvConfig() {
	Config.Env.PORT = os.Getenv("HTTP_KPORT")
	Config.Env.SyncTaskTime = os.Getenv("SYNC_TASK_TIME")
	Config.Mysql.DBAddress = []string{os.Getenv("DB_ADDRESS")}
	Config.Mysql.DBUserName = os.Getenv("DB_USERNAME")
	Config.Mysql.DBPassword = os.Getenv("DB_PASSWORD")
	Config.Mysql.DBDatabaseName = os.Getenv("DB_DATABASENAME")
}
